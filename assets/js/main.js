...
(function ($) {
	...
	if ($('.tp-project-3-wrap').length > 0) {
		...
		pw.add("(min-width: 1200px)", () => {
			...
			gsap.set('.tp-project-3-wrap .pro-img-1', { x: '500' });
			gsap.set('.tp-project-3-wrap .pro-img-2', { x: '-500' });
	...
	// Force dark mode permanently - no settings needed
// Theme settings removed - dark mode is always active

// Force dark mode to be always active
$(document).ready(function(){
	$('html').addClass('Helal-dark-active');
});
